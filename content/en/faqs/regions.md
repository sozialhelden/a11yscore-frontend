...
The lower the number, the larger and more superior the area.

Currently, the a11y-Score uses [administrative levels](https://wiki.openstreetmap.org/wiki/Key:admin_level) 4 to 6:

- **Level 4**: The 16 federal states, e.g., Berlin, Bavaria, North Rhine-Westphalia.
- **Level 5**: Administrative districts (Regierungsbezirke), e.g., the Freiburg district (Regierungsbezirk Freiburg). Not every federal state has these.
- **Level 6**: Rural districts (Landkreise) and urban districts (kreisfreie Städte), e.g., Segeberg district, the city of Aachen.
